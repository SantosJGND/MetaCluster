...
# -------------------------------------------------------
# Run all bacteria analysis scripts
# -------------------------------------------------------
...
STUDY_OUTPUT="/home/bioinf/Desktop/INSA/Projectos/CLUSTER_EVAL/study/analysis/bacteria/output_study"
TAXID_PLAN="/home/bioinf/Desktop/INSA/Manuscripts/Clustering_Clinical_Metagenomics/data/Panel/bacterial_assess.tsv"
ANALYSIS_OUTPUT="/home/bioinf/Desktop/INSA/Projectos/CLUSTER_EVAL/study/analysis/bacteria"
...
echo "========================================================================"
echo " Run all bacteria analysis scripts"
echo "  Python:   $PYTHON"
