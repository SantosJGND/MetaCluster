...
class StructuredLogger:
    ...
    def _log(self, level: int, message: str, extra_data: dict | None = None, exc_info: bool = False):
        if extra_data:
    ...
    def decorator(func):
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.debug(f"Completed {func.__name__}", extra_data={"function": func.__name__, "status": "success"})
                return result
