...
class BatchEvaluator:
    ...
    def _taxids_equal(self, df1: pd.DataFrame | None, df2: pd.DataFrame | None) -> bool:
        """
    ...
    def evaluate(self, dataset_names: list[str], progress: bool = True) -> BatchEvaluationResult:
        """
    ...
    def save_results(
        self, result: BatchEvaluationResult, output_dir: str, save_json: bool = True, save_tsv: bool = True
    ) -> None:
        """
    ...
    def save_summary_statistics(self, result: BatchEvaluationResult, output_dir: str) -> None:
        """
