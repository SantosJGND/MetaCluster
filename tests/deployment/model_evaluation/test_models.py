...
class TestModelTrainer:
    ...
    def test_initialization(self, tmp_path):
        ...
        trainer = ModelTrainer(
            config=config, ncbi_wrapper=ncbi_wrapper, input_tax_df=input_tax_df, taxids_to_use=taxids_to_use
        )
...
class TestCrossValidator:
    ...
    def test_cross_validate_returns_scores(self):
        ...
        with patch.object(
            __import__("sklearn.model_selection", fromlist=["cross_val_score"]), "cross_val_score"
        ) as mock_cv:
...
class TestTrainedModels:
    ...
    def test_trained_models_initialization(self):
        ...
        models = TrainedModels(recall_modeller=recall, composition_modeller=composition, crosshit_modeller=crosshit)
    ...
    def test_is_complete(self):
        ...
        models = TrainedModels(recall_modeller=Mock(), composition_modeller=Mock(), crosshit_modeller=Mock())

        assert models.is_complete is True

        models_incomplete = TrainedModels(recall_modeller=Mock(), composition_modeller=None, crosshit_modeller=Mock())
    ...
    def test_repr(self):
        ...
        models = TrainedModels(recall_modeller=Mock(), composition_modeller=None, crosshit_modeller=Mock())
